...
exports.run = async (client, message, args) => {
    ...
    if (redeemcode === "free10k") {
        if (y.includes(message.author.id)) return message.channel.send("You have already redeemed this code, follow us on twitter for more codes: \nhttps://twitter.com/")
        y += `${message.author.id}, `;
        console.log(y)
        ...
        message.channel.send("Code has been redeemed i have added 10k to your cash, see https://twitter.com/ for more codes")
        })
   }
    } catch (err)  {
